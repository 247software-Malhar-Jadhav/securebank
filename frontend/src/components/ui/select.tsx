...
/**
 * Select — Radix Select styled as shadcn. Keyboard accessible, typeahead, and
 * portal-rendered so it escapes overflow containers. Used for account/currency/
 * type pickers and the language switcher.
 */
